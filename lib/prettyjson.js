...
var renderToArray = function(data, options, indentation) {
  ...
  if (Array.isArray(data)) {
    ...
    var outputArray = [];
      ...
      /**
       * Some breaks as soon as true is returned
       */
    data.some(function(element) {
      //keep track of index
      index++;
      if (index > options.maxArraySize) {
        return true;
      }
...
//       maxArraySize: 512         // Maximum array size
//     }
exports.render = function render(data, options, indentation) {
  ...
  options.maxArraySize = options.maxArraySize || 512;
